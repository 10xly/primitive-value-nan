...
test("setDunderProto", { skip: !setDunderProto }, function (t) {
  ...
  t["throws"](
    function () {
      setDunderProto(undefined)
    },
    TypeError,
    "throws with undefined and nothing"
  )
  t["throws"](
    function () {
      setDunderProto(undefined, undefined)
    },
    TypeError,
    "throws with undefined and undefined"
  )
  // @ts-expect-error
  t["throws"](
    function () {
    ...
    TypeError,
    "throws with null and undefined"
  )
  t["throws"](
    function () {
      setDunderProto(null, undefined)
    },
    TypeError,
    "throws with null and undefined"
  )
