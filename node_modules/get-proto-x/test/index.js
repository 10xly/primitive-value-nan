  ...
  t.test("can get", { skip: !getProto }, function (st) {
    if (getProto) {
      ...
      st.equal(
        getProto(proto),
        Object.prototype,
        "proto: returns the [[Prototype]]"
      )

      st.test("nullish value", function (s2t) {
        s2t["throws"](
          function () {
            return getProto(undefined)
          },
          TypeError,
      ...
      if ("toString" in nullObject) {
        ...
        st.equal(
          getProto(nullObject),
          Object.prototype,
          '"null" object has Object.prototype as [[Prototype]]'
        )
      } else {
        st.equal(
          getProto(nullObject),
          null,
          "null object has null [[Prototype]]"
        )
      }
    }
